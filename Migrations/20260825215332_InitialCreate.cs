        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sabor = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovimientosCuenta_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovimientosCuenta_Ventas_VentaId",
                        column: x => x.VentaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovimientosCuenta_ClienteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovimientosCuenta_VentaId",
                table: "MovimientosCuenta",
                column: "VentaId");
